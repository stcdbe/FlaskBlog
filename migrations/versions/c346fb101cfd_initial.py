...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("default", "author", "admin", name="userstatus"), server_default="default", nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "category",
            sa.Enum(
                "development", "administration", "design", "management", "marketing", "science", name="postcategory"
            ),
            nullable=False,
        ),
